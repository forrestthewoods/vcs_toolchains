...
set_target_properties(clangTidyCppCoreGuidelinesModule PROPERTIES
  INTERFACE_LINK_LIBRARIES "clangTidy;clangTidyMiscModule;clangTidyModernizeModule;clangTidyPerformanceModule;clangTidyReadabilityModule;clangTidyUtils;LLVMFrontendOpenMP;LLVMSupport;\$<LINK_ONLY:clangAST>;\$<LINK_ONLY:clangASTMatchers>;\$<LINK_ONLY:clangBasic>;\$<LINK_ONLY:clangLex>;\$<LINK_ONLY:clangSerialization>;\$<LINK_ONLY:clangTooling>"
)
...
set_target_properties(clangdMain PROPERTIES
  INTERFACE_LINK_LIBRARIES "LLVMSupport;LLVMAArch64Info;LLVMAMDGPUInfo;LLVMARMInfo;LLVMAVRInfo;LLVMBPFInfo;LLVMHexagonInfo;LLVMLanaiInfo;LLVMLoongArchInfo;LLVMMipsInfo;LLVMMSP430Info;LLVMNVPTXInfo;LLVMPowerPCInfo;LLVMRISCVInfo;LLVMSparcInfo;LLVMSystemZInfo;LLVMVEInfo;LLVMWebAssemblyInfo;LLVMX86Info;LLVMXCoreInfo;LLVMFrontendOpenMP;LLVMOption;LLVMTargetParser;\$<LINK_ONLY:clangAST>;\$<LINK_ONLY:clangBasic>;\$<LINK_ONLY:clangFormat>;\$<LINK_ONLY:clangFrontend>;\$<LINK_ONLY:clangLex>;\$<LINK_ONLY:clangSema>;\$<LINK_ONLY:clangTooling>;\$<LINK_ONLY:clangToolingCore>;\$<LINK_ONLY:clangToolingRefactoring>;\$<LINK_ONLY:clangToolingSyntax>;\$<LINK_ONLY:clangTidy>;\$<LINK_ONLY:clangDaemon>;\$<LINK_ONLY:clangdRemoteIndex>;\$<LINK_ONLY:clangdSupport>"
)
